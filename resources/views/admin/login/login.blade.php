    ...
    <style>
        ...
        *{ box-sizing:border-box; margin:0; padding:0; }
        ...
        .panel::after{
            ...
            width:420px;
            height:420px;
            background:radial-gradient(circle, var(--cyan-tint) 0%, transparent 70%);
            pointer-events:none;
        }
        ...
        .panel-mid h1 .accent{ color:var(--cyan); }
    ...
    <div class="shell">
        ...
        <div class="panel">
            ...
            <div class="panel-mid">
                ...
                <p>Manage patient records, book and reschedule appointments, track staff shifts, and control who has access to what — all from one dashboard built specifically for clinic administrators.</p>
            </div>
        ...
        <div class="form-panel">
            <div class="form-inner">
                ...
                <div class="notice">
                    ...
                    <p><strong>Authorized access only.</strong> This portal is restricted to clinic administrators. All activity is logged.</p>
                </div>
            </div>
        </div>
