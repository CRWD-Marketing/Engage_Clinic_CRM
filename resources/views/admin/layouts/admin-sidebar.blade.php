...
<body class="admin-body">
    ...
    <div id="sidebarMobile" class="sidebar-mobile">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('admin.leads') }}" class="sidebar-link {{ request()->routeIs('admin.leads') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.therapists') }}" class="sidebar-link {{ request()->routeIs('admin.therapists') ? 'active' : '' }}">
