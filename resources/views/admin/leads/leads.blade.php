...
<script>
    ...
    const updateStatusUrl = '{{ route("admin.leads.update-status", ["lead" => "__LEAD_ID__"]) }}';
    const storeLeadUrl = '{{ route("admin.leads.store") }}';
    const viewLeadUrl = '{{ route("admin.leads.show", ["lead" => "__LEAD_ID__"]) }}';
    const updateLeadUrl = '{{ route("admin.leads.update", ["lead" => "__LEAD_ID__"]) }}';
